<?php if (!defined('THINK_PATH')) exit();?><form class="layui-form">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="user_name" lay-verify="required" placeholder="请输入联系电话" autocomplete="off"  id="phone" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="password" name="password" lay-verify="required" placeholder="请再次输入密码" autocomplete="off" id="pwd1" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
