...
<form class="layui-form"enctype="multipart/form-data">
    ...
    <div class="layui-form-item" style="margin-top: 50px;"id="sub">
        <div class="layui-input-block">
            ...
            <button class="layui-btn"  lay-submit lay-filter="feedback" id="feedback" style="margin-left: 30px;"  lay-submit lay-filter="user">提交反馈</button>
...
<script>
    ...
    layui.use('form', function(){
        ...
        $('#feedback').click(function(){
            ...
            var back = $('#feedbackbody').val();
            var url = "<?php echo U('Task/FeedBack');?>";

            console.log(workid)
            $.post(url,{'text':back,'workid':workid},function(data) {
